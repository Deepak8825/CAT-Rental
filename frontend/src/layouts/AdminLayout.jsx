...
export default function AdminLayout() {
  ...
  const pageTitle = { dashboard:'Admin Dashboard', fleet:'Fleet Overview', rentals:'Rentals', customers:'Customers', 'ai-copilot':'Fleet AI Copilot', analytics:'Analytics', ai:'AI ML Models', maintenance:'Maintenance', alerts:'Alerts', iot:'IoT Sensors', settings:'Settings' }
